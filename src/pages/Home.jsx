...
const Home = () => {
  ...
  React.useEffect(() => {
    document.title =
      "Aido Group Company Ltd | Official Website - Kigali, Rwanda";
  }, []);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Take a closer look at our vast storage facilities and the premium
              supplies that fuel major construction sites countrywide.
            </p>
          </div>
      ...
      <section className="bg-linear-to-tr from-blue-600 to-orange-700 py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl text-orange-50 mb-10 max-w-2xl mx-auto">
            Skip the delay. Our sales team is active and ready to provide
            instant quotes for your construction material needs. Connect with us
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 border-t-4 border-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm font-medium">
            <a href="#tour" className="hover:text-blue-400 transition-colors">
              Our Materials
            </a>
            <Link
              to="/contact"
          ...
          <p className="text-sm border-t border-slate-800 md:border-none pt-6 md:pt-0 w-full md:w-auto text-center md:text-left">
            &copy; 2026 AIDO Group Company Ltd. All rights reserved. Building
            materials for pros.
          </p>
        </div>
      </footer>
